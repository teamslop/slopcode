...
brew install teamslop/slopcode/slopcode # macOS y Linux (recomendado, siempre al día)
...
nix run nixpkgs#slopcode           # o github:teamslop/slopcode para la rama dev más reciente
```
...
SlopCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](http://github.com/teamslop/slopcode/releases) o desde [slopcode.dev/download](https://slopcode.dev/download).
