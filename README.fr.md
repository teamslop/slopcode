...
npm i -g slopcode-ai@latest        # ou bun/pnpm/yarn
scoop install slopcode             # Windows
choco install slopcode             # Windows
brew install anomalyco/tap/slopcode # macOS et Linux (recommandé, toujours à jour)
...
nix run nixpkgs#slopcode           # ou github:anomalyco/slopcode pour la branche dev la plus récente
```
...
SlopCode est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/anomalyco/slopcode/releases) ou [slopcode.ai/download](https://slopcode.ai/download).
...
En savoir plus sur les [agents](https://slopcode.ai/docs/agents).

### Documentation

Pour plus d'informations sur la configuration d'SlopCode, [**consultez notre documentation**](https://slopcode.ai/docs).
