...
# Paket yöneticileri
npm i -g slopcode-ai@latest        # veya bun/pnpm/yarn
scoop install slopcode             # Windows
choco install slopcode             # Windows
brew install anomalyco/tap/slopcode # macOS ve Linux (önerilir, her zaman güncel)
...
nix run nixpkgs#slopcode           # veya en güncel geliştirme dalı için github:anomalyco/slopcode
```
...
SlopCode ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/anomalyco/slopcode/releases) veya [slopcode.ai/download](https://slopcode.ai/download) adresinden indirebilirsiniz.
...
[Ajanlar](https://slopcode.ai/docs/agents) hakkında daha fazla bilgi edinin.

### Dokümantasyon

SlopCode'u nasıl yapılandıracağınız hakkında daha fazla bilgi için [**dokümantasyonumuza göz atın**](https://slopcode.ai/docs).
