...
# مديري الحزم
npm i -g slopcode-ai@latest        # او bun/pnpm/yarn
...
nix run nixpkgs#slopcode           # او github:anomalyco/slopcode لاحدث فرع dev
```
...
يتوفر SlopCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/anomalyco/slopcode/releases) او من [slopcode.ai/download](https://slopcode.ai/download).
...
تعرف على المزيد حول [agents](https://slopcode.ai/docs/agents).

### التوثيق

لمزيد من المعلومات حول كيفية ضبط SlopCode، [**راجع التوثيق**](https://slopcode.ai/docs).
...
- 100% مفتوح المصدر
- غير مقترن بمزود معين. نوصي بالنماذج التي نوفرها عبر [SlopCode Zen](https://slopcode.ai/zen)؛ لكن يمكن استخدام SlopCode مع Claude او OpenAI او Google او حتى نماذج محلية. مع تطور النماذج ستتقلص الفجوات وستنخفض الاسعار، لذا من المهم ان يكون مستقلا عن المزود.
