...
brew install teamslop/slopcode/slopcode # macOS و Linux (موصى به، دائما محدث)
...
nix run nixpkgs#slopcode           # او github:teamslop/slopcode لاحدث فرع dev
```
...
يتوفر SlopCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](http://github.com/teamslop/slopcode/releases) او من [slopcode.dev/download](https://slopcode.dev/download).
