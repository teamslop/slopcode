...
Use this folder for locale-specific translation guidance that supplements `.slopcode/agent/translator.md`.
...
- PR #12345: http://github.com/grappeggia/slopcode/pull/12345

## Do Not Translate (Locale Additions)

- `SlopCode` (preserve casing)
