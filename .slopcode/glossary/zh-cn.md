...
- PR #13942: https://github.com/anomalyco/slopcode/pull/13942

## Do Not Translate (Locale Additions)

- `SlopCode` (preserve casing in prose; keep `slopcode` only when it is part of commands, package names, paths, or code)
- `SlopCode Zen`
- `SlopCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `slopcode` in prose when referring to the product name; use `SlopCode`
