...
- PR #10809: http://github.com/grappeggia/slopcode/pull/10809
- PR #11496: http://github.com/grappeggia/slopcode/pull/11496

## Do Not Translate (Locale Additions)

- `SlopCode` (preserve casing in prose; keep `slopcode` only in commands, package names, paths, or code)
- `SlopCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
