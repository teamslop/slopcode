...
brew install teamslop/slopcode/slopcode # macOS e Linux (recomendado, sempre atualizado)
...
nix run nixpkgs#slopcode           # ou github:teamslop/slopcode para a branch dev mais recente
```
...
O SlopCode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](http://github.com/teamslop/slopcode/releases) ou em [slopcode.dev/download](https://slopcode.dev/download).
