...
# Менеджери пакетів
npm i -g slopcode-ai@latest        # або bun/pnpm/yarn
scoop install slopcode             # Windows
choco install slopcode             # Windows
brew install anomalyco/tap/slopcode # macOS і Linux (рекомендовано, завжди актуально)
...
nix run nixpkgs#slopcode           # або github:anomalyco/slopcode для найновішої dev-гілки
```
...
SlopCode також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/anomalyco/slopcode/releases) або [slopcode.ai/download](https://slopcode.ai/download).
...
Дізнайтеся більше про [agents](https://slopcode.ai/docs/agents).

### Документація

Щоб дізнатися більше про налаштування SlopCode, [**перейдіть до нашої документації**](https://slopcode.ai/docs).
