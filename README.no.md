...
brew install teamslop/slopcode/slopcode # macOS og Linux (anbefalt, alltid oppdatert)
...
SlopCode er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](http://github.com/teamslop/slopcode/releases) eller [slopcode.dev/download](https://slopcode.dev/download).
