...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  preBuild = ''
    ...
    cp ${slopcode}/bin/slopcode packages/desktop/src-tauri/sidecars/slopcode-cli-${stdenv.hostPlatform.rust.rustcTarget}
  '';
  ...
  postFixup = lib.optionalString stdenv.hostPlatform.isLinux ''
    mv $out/bin/SlopCode $out/bin/slopcode-desktop
    sed -i 's|^Exec=SlopCode$|Exec=slopcode-desktop|' $out/share/applications/SlopCode.desktop
  '';
