...
import { H as HeadConfigSchema, b as urlToSlug, c as slugToLocaleData, d as getSidebarFromConfig, e as getSidebar, f as getSiteTitle, h as getToC, i as getSiteTitleHref, j as getPrevNextLinks, k as getHead, a as attachRouteDataAndRunMiddleware, $ as $$Page } from './middleware_BCJWkldm.mjs';
import { a as stripLeadingAndTrailingSlashes, b as getCollectionPathFromRoot, p as project, s as starlightConfig } from './translations_CIZnHrx6.mjs';
import { I as Icons, d as I18nBadgeConfigSchema, B as BadgeConfigSchema, p as parseAsyncWithFriendlyErrors, e as parseWithFriendlyErrors } from './Code_sjN3308E.mjs';
...
}, "/app/node_modules/.bun/@astrojs+starlight@0.34.3+2337ed27ed217285/node_modules/@astrojs/starlight/components/StarlightPage.astro", void 0);
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  } }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Share", null, { "id": id, "api": apiUrl, "info": data.info, "messages": messages, "client:only": "solid", "client:component-hydration": "only", "client:component-path": "/app/packages/web/src/components/Share.tsx", "client:component-export": "default" })} ` })} `;
}, "/app/packages/web/src/pages/s/[id].astro", void 0);
