...
const file = "/app/packages/web/src/content/docs/pt-br/network.mdx"
const Content = (props = {}) =>
  MDXContent({
    ...props,
...
Content.moduleId = "/app/packages/web/src/content/docs/pt-br/network.mdx"
