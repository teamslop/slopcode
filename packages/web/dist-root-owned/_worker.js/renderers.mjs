...
import {
  ...
  n as AstroJSX,
  A as AstroUserError,
} from "./chunks/astro/server_z27GPXmP.mjs"
...
typeof globalThis != "undefined"
  ? Object.defineProperty(globalThis, O, { value: C$1, configurable: true, writable: false, enumerable: false })
  : typeof window != "undefined"
    ? Object.defineProperty(window, O, { value: C$1, configurable: true, writable: false, enumerable: false })
    : typeof self != "undefined"
      ? Object.defineProperty(self, O, { value: C$1, configurable: true, writable: false, enumerable: false })
...
function j$1(o, e) {
  ...
  for (let n = 0, a = t.length, i; n < a; n++)
    ((i = t[n]),
      i !== "name" &&
        i !== "message" &&
        (i === "stack" ? e & 4 && ((r = r || {}), (r[i] = o[i])) : ((r = r || {}), (r[i] = o[i]))))
  return r
}
function fe$1(o) {
...
function Cr(o) {
  return z$1(
    ...
    "(b=[],a=!0,s=!1,l=[],p=0,f=" +
      ...
      ",e=" +
      z$1(o, ["o", "t"], "(a&&(l[t=p++]=o),n(o)," + S(o, [], "a&&(l[t]=void 0)") + ")") +
...
var Y$1 = class Y {
  constructor(e) {
    this.marked = new Set()
    ;((this.plugins = e.plugins), (this.features = 31 ^ (e.disabledFeatures || 0)), (this.refs = e.refs || new Map()))
  }
  markRef(e) {
    this.marked.add(e)
  }
  ...
  parseIteratorFactory() {
    ...
    return e.type === 1
      ? e.value
      : u$1(27, e.value, s$1, s$1, s$1, s$1, s$1, s$1, s$1, this.parseWellKnownSymbol(Symbol.iterator), s$1, s$1)
  }
...
function Fr(o) {
  ...
  for (let t = 1, n = o.length, a, i = r; t < n; t++)
    ((a = o[t]),
      a.t === 0 && a.v === i.v
        ? (r = { t: 0, s: a.s, k: s$1, v: se$1(r) })
        : a.t === 2 && a.s === i.s
          ? (r = { t: 2, s: se$1(r), k: a.k, v: a.v })
          : a.t === 1 && a.s === i.s
            ? (r = { t: 1, s: se$1(r), k: s$1, v: a.v })
            : a.t === 3 && a.s === i.s
              ? (r = { t: 3, s: se$1(r), k: a.k, v: s$1 })
              : (e.push(r), (r = a)),
      (i = a))
  return (e.push(r), e)
}
...
var Vr = "Object.create(null)",
  ...
  jr = "Promise.resolve",
  _r = "Promise.reject",
  Mr = { 3: "Object.freeze", 2: "Object.seal", 1: "Object.preventExtensions", 0: s$1 },
  V = class {
    constructor(e) {
      this.stack = []
      this.flags = []
    ...
    serializeArrayItem(e, r, t) {
      return r
        ? this.isIndexedValueInStack(r)
          ? (this.markRef(e), this.createArrayAssign(e, t, this.getRefParam(r.i)), "")
          : this.serialize(r)
        : ""
    }
    serializeArray(e) {
      ...
      if (e.l) {
        ...
        for (let i = 1, l = e.l, c; i < l; i++)
          ((c = this.serializeArrayItem(r, t[i], i)), (n += "," + c), (a = c === ""))
    ...
    serializeProperty(e, r, t) {
      if (typeof r == "string") {
        ...
        if (this.isIndexedValueInStack(t)) {
          ...
          return (
            this.markRef(e.i),
            a && n !== n ? this.createObjectAssign(e.i, r, i) : this.createArrayAssign(e.i, a ? r : '"' + r + '"', i),
            ""
          )
        }
    ...
    serializeStringKeyAssignment(e, r, t, n) {
      ...
      if (this.isIndexedValueInStack(n))
        l && i !== i ? this.createObjectAssign(e.i, t, a) : this.createArrayAssign(e.i, l ? t : '"' + t + '"', a)
      else {
    ...
    serializeSetItem(e, r) {
      return this.isIndexedValueInStack(r)
        ? (this.markRef(e), this.createAddAssignment(e, this.getRefParam(r.i)), "")
        : this.serialize(r)
    }
    serializeSet(e) {
      let r = Dr,
    ...
    serializeMap(e) {
      ...
      return (
        a.t === 26 && (this.markRef(a.i), (r = "(" + this.serialize(a) + "," + r + ")")),
      ...
      if (this.isIndexedValueInStack(t)) {
        ...
        r =
          ...
          (e.s
            ...
            : "().catch(" + this.createEffectfulFunction([], "throw " + i) + ")")
      } else {
        this.stack.push(n)
    ...
    serializeIteratorFactory(e) {
      let r = "",
        t = false
      return (
        e.f.t !== 4 && (this.markRef(e.f.i), (r = "(" + this.serialize(e.f) + ","), (t = true)),
    ...
    serializeAsyncIteratorFactory(e) {
      ...
      ;(r.t !== 4 && (this.markRef(r.i), (n += "(" + this.serialize(r))),
        t.t !== 4 && (this.markRef(t.i), (n += (n ? "," : "(") + this.serialize(t))),
        n && (n += ","))
      let a = this.assignIndexedValue(
        ...
        this.createFunction(
          ...
          this.createFunction(
            ["b", "c", "p", "d", "e", "t", "f"],
            "(b=[],c=0,p=[],d=-1,e=!1,f=" +
              this.createEffectfulFunction(["i", "l"], "for(i=0,l=p.length;i<l;i++)p[i].s({done:!0,value:void 0})") +
              ",s.on({next:" +
              this.createEffectfulFunction(["v", "t"], "if(t=p.shift())t.s({done:!1,value:v});b.push(v)") +
              ",throw:" +
              this.createEffectfulFunction(["v", "t"], "if(t=p.shift())t.f(v);f(),d=b.length,e=!0,b.push(v)") +
              ",return:" +
              this.createEffectfulFunction(
                ["v", "t"],
...
var v = class extends Y$1 {
  ...
  parseProperties(e) {
    ...
    return (
      a in e && (t.push(this.parseWellKnownSymbol(a)), n.push(M(this.parseIteratorFactory(), this.parse(J$1(e))))),
      (a = Symbol.asyncIterator),
      a in e && (t.push(this.parseWellKnownSymbol(a)), n.push(U(this.parseAsyncIteratorFactory(), this.parse(K$1())))),
      (a = Symbol.toStringTag),
      a in e && (t.push(this.parseWellKnownSymbol(a)), n.push(w(e[a]))),
      (a = Symbol.isConcatSpreadable),
      a in e && (t.push(this.parseWellKnownSymbol(a)), n.push(e[a] ? I$1 : A$1)),
      { k: t, v: n, s: t.length }
    )
  }
  ...
  parseObject(e, r) {
    ...
    if (a & 1 && typeof AggregateError != "undefined" && (t === AggregateError || r instanceof AggregateError))
...
var oe = class extends v {
  ...
  parseProperties(r) {
    ...
    return (
      i in r && (n.push(this.parseWellKnownSymbol(i)), a.push(M(this.parseIteratorFactory(), this.parse(J$1(r))))),
      (i = Symbol.asyncIterator),
      i in r && (n.push(this.parseWellKnownSymbol(i)), a.push(U(this.parseAsyncIteratorFactory(), this.parse(Ve(r))))),
      (i = Symbol.toStringTag),
      i in r && (n.push(this.parseWellKnownSymbol(i)), a.push(w(r[i]))),
      (i = Symbol.isConcatSpreadable),
      i in r && (n.push(this.parseWellKnownSymbol(i)), a.push(r[i] ? I$1 : A$1)),
      { k: n, v: a, s: n.length }
    )
  }
  handlePromiseSuccess(r, t) {
    let n = this.parseWithError(t)
    ;(n && this.onParse(u$1(23, r, s$1, s$1, s$1, s$1, s$1, s$1, [this.parseSpecialReference(2), n], s$1, s$1, s$1)),
...
function gr(o, e) {
  let r = m$1(e.plugins),
    t = new G$1({
      ...
      onParse(n, a) {
        let i = new D$1({ plugins: r, features: t.features, scopeId: e.scopeId, markedRefs: t.marked }),
          l
        try {
          l = i.serializeTop(n)
        } catch (c) {
...
var De = class {
          ...
          onDone: () => {
            this.alive &&
              ...
              this.pending <= 0 &&
                ...
                !this.done &&
                this.options.onDone &&
                (this.options.onDone(), (this.done = true)))
          },
        }),
      ))
  }
  ...
  flush() {
    this.alive &&
      ((this.flushed = true),
      this.pending <= 0 && !this.done && this.options.onDone && (this.options.onDone(), (this.done = true)))
  }
  close() {
    if (this.alive) {
...
function A(e) {
  this.addEventListener("abort", R.bind(this, e), { once: true })
}
function E(e) {
...
var o = class {
  ...
  D = Hr({
    ...
    deserialize(e, r) {
      let a = r.deserialize(e.controller),
        t = r.deserialize(e.reason)
    ...
    serialize(e, r) {
      return e.type === 0
        ...
        : e.type === 1
          ...
          : "(" + r.serialize(e.controller) + ").signal"
    },
    deserialize(e, r) {
      return e.type === 0
        ? new AbortController().signal
        : e.type === 1
          ...
          : r.deserialize(e.controller).controller.signal
    },
  }),
  C = I
function f(e) {
    ...
    parse: {
      async async(e, r) {
        return {
          ...
          options: await r.parse({ type: e.type, lastModified: e.lastModified }),
...
var i = {},
  ...
  J = Hr({
    ...
    parse: {
      sync(e, r) {
        return { factory: r.parse(i), entries: r.parse(g(e)) }
      },
      async async(e, r) {
        return { factory: await r.parse(i), entries: await r.parse(g(e)) }
      },
      stream(e, r) {
        return { factory: r.parse(i), entries: r.parse(g(e)) }
      },
    ...
    parse: {
      async async(e, r) {
        return {
          ...
          options: await r.parse(h(e, e.body ? await e.clone().arrayBuffer() : null)),
        }
      },
      stream(e, r) {
...
const ES2017FLAG = R$1.AggregateError | R$1.BigIntTypedArray
const GLOBAL_IDENTIFIER = "_$HY.r"
function createSerializer({ onData, onDone, scopeId, onError, plugins: customPlugins }) {
  const defaultPlugins = [C, H, _, Y, K, l, u, ne, ie, me, ue]
  ...
  Object.assign(
    {
      name: "astro:jsx",
      serverEntrypoint:
        "file:///home/marcos/Disk-Extra-4TB/Projects/Personal/slopcode/node_modules/.bun/@astrojs+mdx@4.3.13+2337ed27ed217285/node_modules/@astrojs/mdx/dist/server.js",
    },
    { ssr: server_default },
  ),
]
