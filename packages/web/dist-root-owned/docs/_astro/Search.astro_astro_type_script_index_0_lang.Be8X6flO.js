const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["_astro/ui-core.D7hj7Dnv.js", "_astro/preload-helper.DbOV2x8s.js"]),
) => i.map((i) => d[i])
import { _ as p } from "./preload-helper.DbOV2x8s.js"
...
class h extends HTMLElement {
  constructor() {
    ...
    const r = this.querySelector("button[data-open-modal]"),
      ...
      i = (e) => {
        ;("href" in (e.target || {}) || (document.body.contains(e.target) && !m.contains(e.target))) && n()
      },
      l = (e) => {
        ;(o.showModal(),
    ...
    ;(r.addEventListener("click", l),
      ...
      window.addEventListener("keydown", (e) => {
        ;(e.metaKey === !0 || e.ctrlKey === !0) && e.key === "k" && (o.open ? n() : l(), e.preventDefault())
      }))
    let d = {}
    try {
      d = JSON.parse(this.dataset.translations || "{}")
    } catch {}
    const c = this.dataset.stripTrailingSlash !== void 0 ? (e) => e.replace(/(.)\/(#.*)?$/, "$1$2") : (e) => e
    window.addEventListener("DOMContentLoaded", () => {
      ;(window.requestIdleCallback || ((a) => setTimeout(a, 1)))(async () => {
        const { PagefindUI: a } = await p(
          async () => {
            const { PagefindUI: t } = await import("./ui-core.D7hj7Dnv.js")
            return { PagefindUI: t }
          },
          __vite__mapDeps([0, 1]),
        )
        new a({
          ...
          showSubResults: !0,
          processResult: (t) => {
            ;((t.url = c(t.url)), (t.sub_results = t.sub_results.map((s) => ((s.url = c(s.url)), s))))
          },
        })
      })
    })
