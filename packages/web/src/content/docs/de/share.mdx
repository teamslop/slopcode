---
title: Teilen
description: Teile SlopCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu SlopCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht SlopCode Folgendes:
...
SlopCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt SlopCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`slopcode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du slopcode in deiner Organisation einsetzt.
