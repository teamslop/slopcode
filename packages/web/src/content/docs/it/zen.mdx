...
SlopCode Zen e una lista di modelli testati e verificati dal team di SlopCode.

:::note
SlopCode Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in SlopCode. Accedi a SlopCode Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare SlopCode.
...
SlopCode Zen e un gateway AI che ti da accesso a questi modelli.

---

## Come funziona

SlopCode Zen funziona come qualunque altro provider in SlopCode.

1. Accedi a **<a href={console}>SlopCode Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona SlopCode Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di SlopCode usa il formato `slopcode/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `slopcode/gpt-5.2-codex` nella config.
...
- GLM 4.7 Free e disponibile su SlopCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Kimi K2.5 Free e disponibile su SlopCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiniMax M2.1 Free e disponibile su SlopCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle e un modello stealth gratuito su SlopCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con SlopCode.
