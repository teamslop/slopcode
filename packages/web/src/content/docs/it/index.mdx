...
Puoi anche scaricare il binario dalle [Releases](http://github.com/teamslop/slopcode/releases).
...
Ecco un'esempio di conversazione `https://slopcode.dev/share/<share-id>` con SlopCode.
