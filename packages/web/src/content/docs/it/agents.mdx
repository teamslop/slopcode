...
SlopCode include due subagenti integrati: **General** e **Explore**. Li vediamo sotto.

---

## Integrati

SlopCode include due agenti primari integrati e due subagenti integrati.
...
:::tip
Hai un agente che vorresti condividere? [Invia una PR](https://github.com/anomalyco/slopcode).
:::
