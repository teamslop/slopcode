...
SlopCode est livré avec deux sous-agents intégrés, **General** et **Explore**. Nous verrons cela ci-dessous.

---

## Agents intégrés

SlopCode est livré avec deux agents primaires intégrés et deux sous-agents intégrés.
...
:::tip
Avez-vous un agent que vous aimeriez partager ? [Soumettez un PR](http://github.com/grappeggia/slopcode).
:::
