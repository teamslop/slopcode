...
Vous pouvez sélectionner un thème en affichant la sélection de thème avec la commande `/themes`. Ou vous pouvez le spécifier dans votre [config](/docs/config).
