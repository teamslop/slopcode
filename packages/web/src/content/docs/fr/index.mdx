...
Vous pouvez également récupérer le binaire dans les [Releases](http://github.com/teamslop/slopcode/releases).
...
Voici un exemple de conversation `https://slopcode.dev/share/<share-id>` avec SlopCode.
