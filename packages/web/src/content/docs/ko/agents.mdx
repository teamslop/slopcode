...
SlopCode에는 기본 제공 subagent인 **General**과 **Explore**가 포함되어 있습니다. 아래에서 살펴보겠습니다.

---

## 기본 제공

SlopCode는 기본적으로 primary agent 2개와 subagent 2개를 제공합니다.
...
:::tip
공유하고 싶은 agent가 있나요? [PR 제출하기](http://github.com/grappeggia/slopcode).
:::
