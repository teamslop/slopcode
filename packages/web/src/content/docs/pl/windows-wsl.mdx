---
title: Windows (WSL)
description: Uruchamiaj slopcode na Windows z WSL dla najlepszych efektow.
---

import { Steps } from "@astrojs/starlight/components"

Chociaz slopcode moze dzialac bezposrednio na Windows, dla najlepszych rezultatow zalecamy [Windows Subsystem for Linux (WSL)](https://learn.microsoft.com/en-us/windows/wsl/install). WSL zapewnia srodowisko Linuksa, ktore bardzo dobrze wspolpracuje z funkcjami slopcode.

:::tip[Dlaczego WSL?]
WSL oferuje lepsza wydajnosc systemu plikow, pelna obsluge terminala i zgodnosc z narzedziami developerskimi, na ktorych opiera sie slopcode.
:::
...
2. **Zainstaluj slopcode w WSL**
   ...
   Po skonfigurowaniu WSL otworz terminal WSL i zainstaluj slopcode jedna z [metod instalacji](/docs/).
...
:::caution
Przy uzyciu `--hostname 0.0.0.0` ustaw `SLOPCODE_SERVER_PASSWORD`, aby zabezpieczyc serwer.
...
:::tip
Aby uzyskac najplynniejsza prace, rozwaz sklonowanie/skopiowanie repozytorium do systemu plikow WSL (np. do `~/code/`) i uruchamianie tam slopcode.
:::
...
- Uzywaj [rozszerzenia WSL dla VS Code](https://code.visualstudio.com/docs/remote/wsl) razem z slopcode, aby miec zintegrowany workflow
