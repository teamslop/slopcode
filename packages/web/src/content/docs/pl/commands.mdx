...
Utwórz `.slopcode/commands/test.md`:
...
Możesz zdefiniować polecenia w `slopcode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji slopcode:
...
- Globalnie: `~/.config/slopcode/commands/`
- Na projekt: `.slopcode/commands/`
...
slopcode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
