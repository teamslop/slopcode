...
SlopCode integruje się z protokołem Language Server Protocol (LSP), aby zapewnić modelom LLM kontekst bazy kodu. Wykorzystuje diagnostykę, aby przekazywać informacje zwrotne do LLM.
...
Możesz dostosować serwery LSP poprzez sekcję `lsp` w konfiguracji SlopCode.
