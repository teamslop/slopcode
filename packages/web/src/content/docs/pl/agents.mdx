...
SlopCode ma dwóch wbudowanych subagentów: **General** i **Explore**. Przyjrzymy się im poniżej.

---

## Wbudowane

SlopCode ma dwa wbudowane agenty główne i dwa wbudowane subagenty.
...
:::tip
Masz agenta, którym warto się podzielić? [Prześlij PR](https://github.com/anomalyco/slopcode).
:::
