...
Możesz także pobrać plik binarny z [Releases](http://github.com/teamslop/slopcode/releases).
...
Oto przykładowa rozmowa `https://slopcode.dev/share/<share-id>` z slopcode.
