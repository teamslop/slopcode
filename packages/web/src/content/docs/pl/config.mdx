...
Umieść swoją globalną konfigurację SlopCode w `~/.config/slopcode/slopcode.json`. Użyj jej do ustawień ogólnych dla użytkownika, takich jak motywy, domyślny dostawca lub skróty klawiszowe.
...
Skonfiguruj motyw interfejsu SlopCode za pomocą opcji `theme`.
