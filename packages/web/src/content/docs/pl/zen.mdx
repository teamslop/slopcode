...
SlopCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół slopcode.

:::note
SlopCode Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca slopcode. Logujesz się do SlopCode Zen i dostajesz
...
SlopCode Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

SlopCode Zen działa jak każdy inny dostawca slopcode.

1. Logujesz się do **<a href={console}>SlopCode Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz SlopCode Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji slopcode
używa formatu `slopcode/<model-id>`. Na przykład w przypadku Kodeksu GPT 5.2 zrobiłbyś to
użyj `slopcode/gpt-5.2-codex` w swojej konfiguracji.
...
- GLM 4.7 Free jest dostępny na platformie slopcode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Kimi K2.5 Free jest dostępny na slopcode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- MiniMax M2.1 Free jest dostępny na platformie slopcode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w slopcode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
4. Nie **nie blokuj**, umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalaj na korzystanie z slopcode dowolnego innego dostawcy.
