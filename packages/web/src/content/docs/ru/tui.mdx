---
title: TUI
description: Использование TUI slopcode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

slopcode предоставляет интерактивный terminal интерфейс или TUI для работы над вашими проектами с помощью LLM.

Запуск slopcode запускает TUI для текущего каталога.
...
При использовании slopcode TUI вы можете ввести `/`, а затем имя команды, чтобы быстро выполнить действия. Например:
...
Добавьте провайдера в slopcode. Позволяет выбирать из доступных поставщиков и добавлять их ключи API.
...
Выйдите из slopcode. _Псевдонимы_: `/quit`, `/q`
...
**Привязка клавиш:** `history_mode_toggle` defaults to `ctrl+h,ctrl+j`
...
Вы можете настроить поведение TUI через файл конфигурации slopcode.
