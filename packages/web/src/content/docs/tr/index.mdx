...
İkili dosyayı [Releases](https://github.com/anomalyco/slopcode/releases)'dan da alabilirsiniz.
...
İşte slopcode'lu bir [örnek konuşma](https://slopcode.ai/s/4XP1fce5).
