...
İkili dosyayı [Releases](http://github.com/grappeggia/slopcode/releases)'dan da alabilirsiniz.
...
İşte slopcode'lu bir [örnek konuşma](https://slopcode.dev/s/4XP1fce5).
