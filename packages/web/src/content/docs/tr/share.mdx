---
title: Paylasim
description: slopcode konusmalarini genel baglantilarla paylasin.
---

slopcode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda slopcode:
...
slopcode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak slopcode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `slopcode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda slopcode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
