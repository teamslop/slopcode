...
slopcode, **General** ve **Explore** olmak üzere iki yerleşik alt agent ile birlikte gelir. Buna aşağıda bakacağız.

---

## Yerleşik

slopcode iki yerleşik birincil agent ve iki yerleşik alt agent ile birlikte gelir.
...
slopcode hesabınızdaki model kimliğini `provider/model-id` biçimini kullanır. Örneğin, [SlopCode Zen](/docs/zen) kullanıyorsanız, GPT 5.1 Codex için `slopcode/gpt-5.1-codex` kullanırsınız.
...
:::tip
Paylaşmak istediğiniz bir agent'ınız var mı? [Submit a PR](https://github.com/anomalyco/slopcode).
:::
