---
title: GitLab
description: 在 GitLab issue 和合并请求中使用 SlopCode。
---
...
SlopCode 可以在常规的 GitLab 流水线中运行。你可以将其作为 [CI 组件](https://docs.gitlab.com/ee/ci/components/) 集成到流水线中。

这里我们使用的是社区创建的 SlopCode CI/CD 组件 — [nagyv/gitlab-slopcode](https://gitlab.com/nagyv/gitlab-slopcode)。
...
有关更多输入参数和使用场景，请[查看该组件的文档](https://gitlab.com/explore/catalog/nagyv/gitlab-slopcode)。

---

## GitLab Duo

SlopCode 与你的 GitLab 工作流集成。
在评论中提及 `@slopcode`，SlopCode 将在你的 GitLab CI 流水线中执行任务。
