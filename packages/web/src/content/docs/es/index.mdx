...
También puede obtener el binario de [Versiones](http://github.com/grappeggia/slopcode/releases).
...
Aquí hay una [conversación de ejemplo](https://slopcode.dev/s/4XP1fce5) con SlopCode.
