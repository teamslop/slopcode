...
También puede obtener el binario de [Versiones](http://github.com/teamslop/slopcode/releases).
...
Aquí hay una conversación de ejemplo `https://slopcode.dev/share/<share-id>` con SlopCode.
