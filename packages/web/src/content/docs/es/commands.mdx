...
Crear `.slopcode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración SlopCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su SlopCode [config](/docs/config):
...
- Por proyecto: `.slopcode/commands/`
...
slopcode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
