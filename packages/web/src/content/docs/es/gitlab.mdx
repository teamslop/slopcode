---
title: GitLab
description: Utilice SlopCode en problemas GitLab y solicitudes de fusión.
---
...
SlopCode funciona en una tubería GitLab normal. Puede integrarlo en una canalización como un [componente de CI](https://docs.gitlab.com/ee/ci/components/)

Aquí estamos utilizando un componente CI/CD creado por la comunidad para SlopCode — [nagyv/gitlab-slopcode](https://gitlab.com/nagyv/gitlab-slopcode).
...
Para obtener más entradas y casos de uso, [consulte los documentos](https://gitlab.com/explore/catalog/nagyv/gitlab-slopcode) de este componente.

---

## GitLab Duo

SlopCode se integra con su flujo de trabajo GitLab.
Mencione `@slopcode` en un comentario y SlopCode ejecutará tareas dentro de su canal de CI GitLab.
...
- **Reparar e implementar**: pídale a SlopCode que solucione un problema o implemente una función.
...
:::tip
Puede configurarlo para utilizar una frase de activación diferente a `@slopcode`.
:::
