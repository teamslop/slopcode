...
Puede definir servidores MCP en su [SlopCode Config](https://slopcode.ai/docs/config/) en `mcp`. Agregue cada MCP con un nombre único. Puede referirse a ese MCP por su nombre cuando solicite el LLM.
