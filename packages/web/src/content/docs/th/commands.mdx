...
สร้าง `.slopcode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ SlopCode:
...
- ระดับผู้ใช้ (Global): `~/.config/slopcode/commands/`
- ระดับโปรเจ็กต์: `.slopcode/commands/`
...
SlopCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
