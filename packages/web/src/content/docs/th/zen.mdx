...
SlopCode Zen คือรายการโมเดลที่ได้รับการทดสอบและตรวจสอบแล้วโดยทีมงาน SlopCode

:::note
SlopCode Zen ปัจจุบันอยู่ในช่วงเบต้า
:::

Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน SlopCode คุณเข้าสู่ระบบ SlopCode Zen และรับ
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่เลือกซึ่งทำงานได้ดีกับ SlopCode
:::
...
SlopCode Zen เป็นเกตเวย์ AI ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## มันทำงานอย่างไร

SlopCode Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน SlopCode

1. คุณลงชื่อเข้าใช้ **<a href={console}>SlopCode Zen</a>** เพิ่มการเรียกเก็บเงินของคุณ
   รายละเอียดและคัดลอกรหัส API ของคุณ
2. คุณรันคำสั่ง `/connect` ใน TUI เลือก SlopCode Zen และวางคีย์ API ของคุณ
...
| Claude Haiku 3.5   | claude-haiku-3-5   | `https://slopcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
...
[model id](/docs/config/#models) ในการกำหนดค่า SlopCode ของคุณ
ใช้รูปแบบ `slopcode/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.2 Codex คุณจะต้อง
ใช้ `slopcode/gpt-5.2-codex` ในการกำหนดค่าของคุณ
...
- GLM 4.7 ใช้งานได้ฟรีบน SlopCode ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Kimi K2.5 Free พร้อมใช้งานบน SlopCode ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- MiniMax M2.1 Free พร้อมใช้งานบน SlopCode ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Big Pickle เป็นโมเดลล่องหนที่ให้บริการฟรีบน SlopCode ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
...
4. **ไม่มีการล็อคอิน** โดยอนุญาตให้คุณใช้กับเอเจนต์การเขียนโค้ดอื่นๆ และให้คุณใช้ผู้ให้บริการรายอื่นกับ SlopCode ได้เช่นกัน
