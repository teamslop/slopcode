...
SlopCode leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

SlopCode leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/anomalyco/slopcode).
:::
