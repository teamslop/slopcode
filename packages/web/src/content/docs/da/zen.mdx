...
| Claude Sonnet 4.5   | claude-sonnett-4-5 | `https://slopcode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4     | claude-sonnett-4   | `https://slopcode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
...
| Gemini 3 Pro        | gemini-3-pro       | `https://slopcode.ai/zen/v1/models/gemini-3-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash      | gemini-3-flash     | `https://slopcode.ai/zen/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| MiniMax M2.1        | minimax-m2.1       | `https://slopcode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.1 Gratis | minimax-m2.1-free  | `https://slopcode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7             | glm-4.7            | `https://slopcode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Gratis      | glm-4.7-free       | `https://slopcode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.6             | glm-4.6            | `https://slopcode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5           | kimi-k2.5          | `https://slopcode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5 Gratis    | kimi-k2.5-free     | `https://slopcode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Tenker      | kimi-k2-thinking   | `https://slopcode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2             | kimi-k2            | `https://slopcode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3-koder 480B    | qwen3-coder        | `https://slopcode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Stor sylteagurk     | big-pickle         | `https://slopcode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
