...
:::note
SlopCode Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i SlopCode. Du logger på SlopCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med SlopCode.
:::
...
SlopCode Zen fungerer som alle andre udbydere i SlopCode.

1. Du logger på **<a href={console}>SlopCode Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger SlopCode Zen og indsætter API-nøglen.
...
| Claude Sonnet 4.5   | claude-sonnett-4-5 | `https://slopcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4     | claude-sonnett-4   | `https://slopcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
...
| Gemini 3 Pro        | gemini-3-pro       | `https://slopcode.dev/zen/v1/models/gemini-3-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash      | gemini-3-flash     | `https://slopcode.dev/zen/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| MiniMax M2.1        | minimax-m2.1       | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.1 Gratis | minimax-m2.1-free  | `https://slopcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7             | glm-4.7            | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Gratis      | glm-4.7-free       | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.6             | glm-4.6            | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5           | kimi-k2.5          | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5 Gratis    | kimi-k2.5-free     | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Tenker      | kimi-k2-thinking   | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2             | kimi-k2            | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3-koder 480B    | qwen3-coder        | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Stor sylteagurk     | big-pickle         | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

[model-id](/docs/config/#models) i SlopCode-konfigurationen
bruger formatet `slopcode/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `slopcode/gpt-5.2-codex` i din konfiguration.
...
- GLM 4.7 Gratis er tilgængelig på SlopCode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Kimi K2.5 Gratis er tilgængelig på SlopCode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- MiniMax M2.1 Gratis er tilgængelig på SlopCode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på SlopCode i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede SlopCode Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med SlopCode også.
