...
Agentferdigheter lar SlopCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går SlopCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
SlopCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `slopcode.json`:
