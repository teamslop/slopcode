...
Opret `.slopcode/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem SlopCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din SlopCode [config](/docs/config):
...
- Globalt: `~/.config/slopcode/commands/`
- Pr. projekt: `.slopcode/commands/`
...
slopcode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
