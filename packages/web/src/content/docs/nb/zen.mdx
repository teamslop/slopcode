...
:::note
SlopCode Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i SlopCode. Du logger på SlopCode Zen og får
...
SlopCode Zen fungerer som alle andre leverandører i SlopCode.

1. Du logger på **<a href={console}>SlopCode Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger SlopCode Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i SlopCode-konfigurasjonen
bruker formatet `slopcode/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `slopcode/gpt-5.2-codex` i konfigurasjonen din.
...
- GLM 4.7 Free er tilgjengelig på SlopCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Kimi K2.5 Free er tilgjengelig på SlopCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- MiniMax M2.1 Free er tilgjengelig på SlopCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på SlopCode i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med slopcode også.
