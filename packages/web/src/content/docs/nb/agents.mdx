...
SlopCode kommer med to innebygde underagenter, **General** og **Explore**. Vi skal se på dette nedenfor.

---

## Innebygd

SlopCode kommer med to innebygde primære agenter og to innebygde underagenter.
...
:::tip
Har du en agent du vil dele? [Send inn en PR](http://github.com/grappeggia/slopcode).
:::
