...
Kreiraj `.slopcode/commands/test.md`:
...
Možete dodati prilagođene komande kroz SlopCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom SlopCode [config](/docs/config):
...
- Globalno: `~/.config/slopcode/commands/`
- Po projektu: `.slopcode/commands/`
...
SlopCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
