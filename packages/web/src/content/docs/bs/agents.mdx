...
SlopCode dolazi sa dva ugrađena subagenta, **General** i **Explore**. Ovo ćemo pogledati u nastavku.

---

## Ugrađeni

SlopCode dolazi sa dva ugrađena primarna agenta i dva ugrađena subagenta.
...
:::tip
Imate li agenta kojeg biste željeli podijeliti? [Pošalji PR](https://github.com/anomalyco/slopcode).
:::
