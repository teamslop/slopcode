...
Također možete preuzeti binarnu datoteku iz [Releases](http://github.com/teamslop/slopcode/releases).
...
:::
Evo primjer razgovora `https://slopcode.dev/share/<share-id>` sa SlopCode.
