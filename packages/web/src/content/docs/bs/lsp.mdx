...
SlopCode se integriše sa vašim Language Server Protocol (LSP) serverima kako bi pomogao LLM-u u interakciji s kodnom bazom. Koristi dijagnostiku za slanje povratnih informacija modelu.
...
Možete prilagoditi LSP servere kroz `lsp` odjeljak u vašoj slopcode konfiguraciji.
