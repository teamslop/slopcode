...
يأتي SlopCode مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي SlopCode مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](http://github.com/grappeggia/slopcode).
:::
