...
在 SlopCode [設定](/docs/config)中使用 `command` 選項：
...
- 全域：`~/.config/slopcode/commands/`
- 專案層級：`.slopcode/commands/`
...
SlopCode 包含多個內建指令，如 `/init`、`/undo`、`/redo`、`/share`、`/help`；[了解更多](/docs/tui#commands)。
