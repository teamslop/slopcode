---
title: GitLab
description: Use SlopCode in GitLab issues and merge requests.
---
...
SlopCode works in a regular GitLab pipeline. You can build it into a pipeline as a [CI component](https://docs.gitlab.com/ee/ci/components/)

Here we are using a community-created CI/CD component for SlopCode — [nagyv/gitlab-slopcode](https://gitlab.com/nagyv/gitlab-slopcode).
...
For more inputs and use cases [check out the docs](https://gitlab.com/explore/catalog/nagyv/gitlab-slopcode) for this component.

---

## GitLab Duo

SlopCode integrates with your GitLab workflow.
Mention `@slopcode` in a comment, and SlopCode will execute tasks within your GitLab CI pipeline.
...
- **Fix and implement**: Ask SlopCode to fix an issue or implement a feature.
...
:::tip
You can configure to use a different trigger phrase than `@slopcode`.
:::
