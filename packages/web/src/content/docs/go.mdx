...
SlopCode Go is a low cost **$10/month** subscription that gives you reliable access to popular open coding models.

:::note
SlopCode Go is currently in beta.
:::
...
SlopCode Go gives you access to these models for **$10/month**.
...
SlopCode Go is a **$10/month** subscription plan. Below are the prices **per 1M tokens**.
...
| Kimi K2.5    | kimi-k2.5    | `https://slopcode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
...
uses the format `slopcode-go/<model-id>`. For example, for Kimi K2.5, you would
use `slopcode-go/kimi-k2.5` in your config.
