---
title: Windows (WSL)
description: Execute o slopcode no Windows com WSL para melhor experiência.
---

import { Steps } from "@astrojs/starlight/components"

Embora o slopcode possa rodar direto no Windows, recomendamos usar [Windows Subsystem for Linux (WSL)](https://learn.microsoft.com/en-us/windows/wsl/install) para a melhor experiência. O WSL oferece um ambiente Linux que funciona de forma integrada com os recursos do slopcode.

:::tip[Por que WSL?]
O WSL oferece melhor desempenho de sistema de arquivos, suporte completo a terminal e compatibilidade com as ferramentas de desenvolvimento das quais o slopcode depende.
:::
...
2. **Instale o slopcode no WSL**
   ...
   Depois de configurar o WSL, abra o terminal do WSL e instale o slopcode usando um dos [métodos de instalação](/docs/).
...
:::caution
Ao usar `--hostname 0.0.0.0`, defina `SLOPCODE_SERVER_PASSWORD` para proteger o servidor.
...
:::tip
Para uma experiência mais fluida, considere clonar/copiar seu repositório para o sistema de arquivos do WSL (por exemplo em `~/code/`) e executar o slopcode por lá.
:::
...
- Use a [extensão WSL do VS Code](https://code.visualstudio.com/docs/remote/wsl) junto com o slopcode para um fluxo de desenvolvimento integrado
