...
slopcode vem com dois subagentes integrados, **General** e **Explore**. Vamos ver isso abaixo.

---

## Integrados

slopcode vem com dois agentes primários integrados e dois subagentes integrados.
...
:::tip
Você tem um agente que gostaria de compartilhar? [Envie um PR](http://github.com/grappeggia/slopcode).
:::
