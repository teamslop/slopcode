...
Você também pode baixar o binário na seção [Releases](http://github.com/teamslop/slopcode/releases).
...
Aqui está uma conversa de exemplo `https://slopcode.dev/share/<share-id>` com o slopcode.
