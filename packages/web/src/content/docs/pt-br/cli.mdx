...
| `--attach`   |       | Anexe a um servidor slopcode em execução (por exemplo, http://localhost:4096) |
...
| Flag       | Curto | Descrição                                                                                                                                                |
| ---------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--method` | `-m`  | O método de instalação que foi usado; curl, npm, pnpm, yarn, bun, nix, brew, macports, apt, zypper, dnf, yum, apk, pkg, pacman, paru, snap, choco, scoop |
...
| `SLOPCODE_DISABLE_FILETIME_CHECK`     | boolean | Desabilitar verificação de tempo de arquivo para otimização           |
...
| Variável                                        | Tipo    | Descrição                                                 |
| ----------------------------------------------- | ------- | --------------------------------------------------------- |
| `SLOPCODE_EXPERIMENTAL`                         | boolean | Habilitar todos os recursos experimentais                 |
...
| `SLOPCODE_EXPERIMENTAL_LSP_TY`                  | boolean | Habilitar verificação de tipo LSP experimental            |
| `SLOPCODE_EXPERIMENTAL_MARKDOWN`                | boolean | Habilitar recursos experimentais de markdown              |
