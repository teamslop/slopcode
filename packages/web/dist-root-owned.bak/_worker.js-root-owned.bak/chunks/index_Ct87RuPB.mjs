...
import { aE as requireCssesc, az as commonjsGlobal, aA as getDefaultExportFromCjs } from "./astro/server_z27GPXmP.mjs"
...
export {
  ...
  PluginTexts as i,
  changeAlphaToReachColorContrast as j,
  changeLuminanceToReachColorContrast as k,
  chromaticRecolor as l,
  codeLineClass as m,
  createInlineSvgUrl as n,
  darken as o,
  pluginFramesTexts as p,
  ensureColorContrastOnBackground as q,
  getCssVarName as r,
  getFirstStaticColor as s,
  getLuminance as t,
  getStaticBackgroundColor as u,
  isInlineStyleAnnotation as v,
  lighten as w,
  multiplyAlpha as x,
  onBackground as y,
