...
SlopCode verfügt über eine Liste von Tastenkombinationen, die Sie über die SlopCode-Konfiguration anpassen können.
...
:::tip
By default, `history_mode_toggle` includes `ctrl+j`, which can conflict with `input_newline`.
:::
