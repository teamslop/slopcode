...
يتكامل SlopCode مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات slopcode.
