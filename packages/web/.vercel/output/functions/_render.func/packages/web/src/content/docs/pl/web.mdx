...
![Sieć slopcode - Nowa sesja](../../../assets/web/web-homepage-new-session.png)
...
:::caution
Jeśli `SLOPCODE_SERVER_PASSWORD` nie jest ustawione, serwer będzie niezabezpieczony. Jest to dobre rozwiązanie do użytku lokalnego, ale powinno być ustawione na dostęp do sieci.
:::

:::tip[Windows Users]
Aby uzyskać najlepsze wyniki, uruchom `slopcode web` z [WSL](/docs/windows-wsl) zamiast programu PowerShell. Zapewnia to prawidłowy dostęp do systemu plików i integrację terminala.
:::
...
![slopcode Web - Aktywna sesja](../../../assets/web/web-homepage-active-session.png)
