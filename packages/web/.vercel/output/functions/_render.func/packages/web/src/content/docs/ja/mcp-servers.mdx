...
MCP は、組み込みツールと並んで、SlopCode のツールとして利用できます。したがって、他のツールと同様に、SlopCode config を通じてそれらを管理できます。
...
これにより、ブラウザ ウィンドウが開き、OAuth フローが完了し、SlopCode が Sentry アカウントに接続されます。
