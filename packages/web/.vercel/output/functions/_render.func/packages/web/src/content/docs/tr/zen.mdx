...
SlopCode Zen, slopcode ekibi tarafindan test edilip dogrulanmis modellerin listesidir.

:::note
SlopCode Zen su anda beta asamasindadir.
:::

Zen, slopcode'daki diger provider'lar gibi calisir. SlopCode Zen'e giris yapar ve API anahtarinizi alirsiniz.
Tamamen istege baglidir; slopcode kullanmak icin Zen kullanmak zorunda degilsiniz.
...
:::tip
slopcode ile iyi calisan belirli model/provider kombinasyonlarini test ettik.
:::
...
SlopCode Zen, bu modellere erisim saglayan bir AI gateway'dir.

---

## Nasil calisir

SlopCode Zen, slopcode'daki diger provider'lar gibi calisir.

1. **<a href={console}>SlopCode Zen</a>** hesabina giris yapin, odeme bilgilerinizi ekleyin ve API anahtarinizi kopyalayin
2. TUI'da `/connect` komutunu calistirin, SlopCode Zen'i secin ve API anahtarinizi yapistirin
...
| MiniMax M2.1 Free  | minimax-m2.1-free  | `https://slopcode.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7            | glm-4.7            | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Free       | glm-4.7-free       | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| Kimi K2.5 Free     | kimi-k2.5-free     | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Thinking   | kimi-k2-thinking   | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2            | kimi-k2            | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3 Coder 480B   | qwen3-coder        | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Big Pickle         | big-pickle         | `https://slopcode.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

slopcode config'inizdeki [model id](/docs/config/#models), `slopcode/<model-id>` formatini kullanir.
Ornegin GPT 5.2 Codex icin config'te `slopcode/gpt-5.2-codex` kullanirsiniz.
...
- GLM 4.7 Free, sinirli bir sure icin slopcode'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Kimi K2.5 Free, sinirli bir sure icin slopcode'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- MiniMax M2.1 Free, sinirli bir sure icin slopcode'da ucretsizdir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
- Big Pickle, sinirli bir sure icin slopcode'da ucretsiz olan gizli bir modeldir. Ekip bu surede geri bildirim toplayip modeli iyilestiriyor
...
SlopCode Zen'i su amaclarla olusturduk:
...
4. Herhangi bir kodlama ajaniyla kullanima izin vererek **kilitlenmeyi onlemek** ve slopcode'da diger provider'lari her zaman acik tutmak
