...
:::note
SlopCode Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans SlopCode. Vous vous connectez à SlopCode Zen et obtenez
...
SlopCode Zen est une passerelle IA qui vous donne accès à ces modèles.
...
1. Vous vous connectez à **<a href={console}>SlopCode Zen</a>**, ajoutez votre facturation
...
Le [id du modèle](/docs/config/#models) dans votre configuration SlopCode
utilise le format `slopcode/<model-id>`. Par exemple, pour GPT 5.2 Codex, vous devez
utilisez `slopcode/gpt-5.2-codex` dans votre configuration.
...
- GLM 4.7 Free est disponible sur SlopCode pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Kimi K2.5 Free est disponible sur SlopCode pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- MiniMax M2.1 Free est disponible sur SlopCode pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
- Big Pickle est un modèle furtif gratuit sur SlopCode pour une durée limitée. L’équipe profite de ce temps pour recueillir des commentaires et améliorer le modèle.
...
4. N'ayez **aucun verrouillage** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et laissez-vous toujours utiliser n'importe quel autre fournisseur avec SlopCode également.
