...
- `client`: Yapay zeka ile etkileşime geçmek için slopcode'lu bir SDK istemcisi.
...
Seviyeler: `debug`, `info`, `warn`, `error`. Ayrıntılar için [SDK documentation](https://slopcode.dev/docs/sdk)'e bakın.
