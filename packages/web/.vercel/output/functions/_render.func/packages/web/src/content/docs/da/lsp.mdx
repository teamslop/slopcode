...
SlopCode integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.
...
Når slopcode åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din slopcode-konfiguration.
