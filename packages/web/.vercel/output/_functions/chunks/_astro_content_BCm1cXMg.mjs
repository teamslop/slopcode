import { A as AstroError, U as UnknownContentCollectionError, a as createComponent, k as RenderUndefinedEntryError, j as escape, u as unescapeHTML, b as renderTemplate, e as AstroUserError, l as renderUniqueStylesheet, m as renderScriptElement, n as createHeadAndContent, r as renderComponent } from './astro/server_w_dG-Dok.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Cu7JbtAy.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://slopcode.dev", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CIzr_Ct7.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_AeF5T-R8.mjs');
