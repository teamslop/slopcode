const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["_astro/ui-core.5vfW5kUq.js", "_astro/preload-helper.BlTxHScW.js"]),
) => i.map((i) => d[i])
import { _ as p } from "./preload-helper.BlTxHScW.js"
    ...
    window.addEventListener("DOMContentLoaded", () => {
      ;(window.requestIdleCallback || ((a) => setTimeout(a, 1)))(async () => {
        const { PagefindUI: a } = await p(
          async () => {
            const { PagefindUI: t } = await import("./ui-core.5vfW5kUq.js")
            return { PagefindUI: t }
          },
          __vite__mapDeps([0, 1]),
        )
