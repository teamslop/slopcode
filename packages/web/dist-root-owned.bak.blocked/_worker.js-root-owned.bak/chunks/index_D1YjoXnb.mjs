...
import {
  ...
  M as RewriteWithBodyUsed,
  O as MiddlewareNoDataOrNextCalled,
  P as MiddlewareNotAResponse,
  Q as GetStaticPathsRequired,
  S as InvalidGetStaticPathsReturn,
