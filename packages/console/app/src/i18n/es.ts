...
export const dict = {
  ...
  "workspace.lite.promo.description":
    "SlopCode Go es una suscripción de $10 al mes que proporciona acceso confiable a modelos de codificación abiertos populares con generosos límites de uso.",
