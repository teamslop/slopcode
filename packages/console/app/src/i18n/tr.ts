...
export const dict = {
  ...
  "home.faq.a5.beforeDesktop": "Artık hayır! SlopCode şimdi",
  ...
  "workspace.lite.promo.title": "SlopCode Go",
  "workspace.lite.promo.description":
    "SlopCode Go, cömert kullanım limitleriyle popüler açık kodlama modellerine güvenilir erişim sağlayan aylık 10$'lık bir aboneliktir.",
