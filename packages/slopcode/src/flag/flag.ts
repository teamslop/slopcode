...
export namespace Flag {
  ...
  export const SLOPCODE_EXPERIMENTAL_WORKSPACES_TUI =
    SLOPCODE_EXPERIMENTAL || truthy("SLOPCODE_EXPERIMENTAL_WORKSPACES_TUI") || truthy("OPENCODE_EXPERIMENTAL_WORKSPACES_TUI")
