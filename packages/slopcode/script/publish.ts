...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    "url='https://github.com/anomalyco/slopcode'",
    "arch=('aarch64' 'x86_64')",
    "license=('MIT')",
    "provides=('slopcode')",
    "conflicts=('slopcode')",
    "depends=('ripgrep')",
    "",
    `source_aarch64=("\${pkgname}_\${pkgver}_aarch64.tar.gz::https://github.com/anomalyco/slopcode/releases/download/v\${pkgver}\${_subver}/slopcode-linux-arm64.tar.gz")`,
    `sha256sums_aarch64=('${arm64Sha}')`,

    `source_x86_64=("\${pkgname}_\${pkgver}_x86_64.tar.gz::https://github.com/anomalyco/slopcode/releases/download/v\${pkgver}\${_subver}/slopcode-linux-x64.tar.gz")`,
  ...
  const homebrewFormula = [
    ...
    `  homepage "https://github.com/anomalyco/slopcode"`,
    ...
    `      url "https://github.com/anomalyco/slopcode/releases/download/v${Script.version}/slopcode-darwin-x64.zip"`,
    `      sha256 "${macX64Sha}"`,
    "",
    "      def install",
    ...
    "    end",
    "    if Hardware::CPU.arm?",
    `      url "https://github.com/anomalyco/slopcode/releases/download/v${Script.version}/slopcode-darwin-arm64.zip"`,
    `      sha256 "${macArm64Sha}"`,
    "",
    "      def install",
    '        bin.install "slopcode"',
    ...
    `      url "https://github.com/anomalyco/slopcode/releases/download/v${Script.version}/slopcode-linux-x64.tar.gz"`,
    `      sha256 "${x64Sha}"`,
    "      def install",
    '        bin.install "slopcode"',
    "      end",
    ...
    `      url "https://github.com/anomalyco/slopcode/releases/download/v${Script.version}/slopcode-linux-arm64.tar.gz"`,
    `      sha256 "${arm64Sha}"`,
    "      def install",
    '        bin.install "slopcode"',
    "      end",
