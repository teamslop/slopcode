...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders SLOPCODE_CALLER", () => {
    process.env["SLOPCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode SLOPCODE_CALLER", () => {
    process.env["SLOPCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown SLOPCODE_CALLER", () => {
    process.env["SLOPCODE_CALLER"] = "unknown"
