export const dict = {
  ...
  "desktop.menu.help.documentation": "SlopCode Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "SlopCode CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
