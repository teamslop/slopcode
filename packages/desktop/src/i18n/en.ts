export const dict = {
  ...
  "desktop.menu.help.documentation": "SlopCode Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "SlopCode CLI binary is missing. Try reinstalling the desktop app.",
