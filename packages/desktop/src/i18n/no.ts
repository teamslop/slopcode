export const dict = {
  ...
  "desktop.menu.help.documentation": "SlopCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "SlopCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
